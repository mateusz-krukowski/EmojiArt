...
struct EmojiArtDocumentView: View {
    ...
    var body: some View {
        VStack {
            HStack {
                ...
                .onAppear {
                    chosenPalette = self.document.defaultPalette
                }
            }
                    ...
                    Image(systemName: "doc.on.clipboard").imageScale(.large)
                        .alert(isPresented: self.$explainBackgroundPaste) {
                            return Alert(title: Text("Paste Background"),
                                         message: Text("Copy the URL of and image to the clipboard and touch this button to make it a background od your document"),
    ...
    private func zoomGesture() -> some Gesture {
        MagnificationGesture() // A pinch gesture
